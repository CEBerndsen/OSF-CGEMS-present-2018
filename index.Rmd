...
2. Within the new component, modify the home wiki page with information on your isolate

**Throughout the workshop:** 

  - Fill in additional components for new experiments 
  
  - Wiki pages using markdown language and the notebook template provided
